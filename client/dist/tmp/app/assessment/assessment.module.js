...
var member_dialog_component_1 = require("./exam/member-dialog/member-dialog.component");
...
var AssessmentModule = (function () {
    ...
    AssessmentModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [assessment_component_1.AssessmentComponent, exam_list_component_1.ExamListComponent, exam_dialog_component_1.ExamDialog, member_dialog_component_1.ExamMemberDialog,
            ...
            providers: [],
            exports: [question_container_directive_1.QuestionContainerDirective],
