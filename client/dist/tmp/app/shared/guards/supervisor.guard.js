...
var exam_member_model_1 = require("../models/exam-member.model");
var SupervisorGuard = (function () {
    ...
    SupervisorGuard.prototype.canActivate = function (route, state) {
        ...
        return exam_member_model_1.ExamMember.byExamAndUser(this, this.authService.CurrentUser.id, examId)
            .map(function (member) {
