...
var course_member_model_1 = require("../models/course-member.model");
var TeacherGuard = (function () {
    ...
    TeacherGuard.prototype.canActivate = function (route, state) {
        ...
        return course_member_model_1.CourseMember.byCourseAndUser(this, this.authService.CurrentUser.id, courseId)
            .map(function (member) {
