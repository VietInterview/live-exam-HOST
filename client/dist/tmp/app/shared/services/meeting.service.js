...
var MeetingService = (function () {
    ...
    MeetingService.prototype.join = function (room_ref, member_ref) {
        this.nativeWindow.open(env_config_1.Config.CONFERENCE_ENDPOINT + "?room=" + room_ref + "&member=" + member_ref + "&cloudid=" + this.authService.StoredCredential.cloud_account.id);
    };
