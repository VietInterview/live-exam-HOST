...
var enrollment_routing_1 = require("../enrollment/enrollment-routing");
                ...
                router_1.RouterModule.forChild([
                    {
                        ...
                        children: dashboard_routing_1.DashboardRoutes.concat(setting_routing_1.SettingRoutes, account_routing_1.AccountRoutes, enrollment_routing_1.EnrollmentRoutes, assessment_routing_1.AssessmentRoutes, report_routing_1.ReportRoutes, lms_routing_1.LMSRoutes)
                    },
                    { path: '**', redirectTo: '' }
                ])
            ],
