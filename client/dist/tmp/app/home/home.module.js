    ...
    HomeModule = HomeModule_1 = __decorate([
        core_1.NgModule({
            ...
            declarations: [home_component_1.HomeComponent, navbar_component_1.NavbarComponent, side_menu_component_1.SideMenuComponent,
                footer_component_1.FooterComponent, sub_menu_component_1.SubMenuComponent, breadcrumb_component_1.BreadcrumbComponent, change_password_dialog_component_1.ChangePasswordDialog],
            exports: [],
            providers: []
        })
    ], HomeModule);
